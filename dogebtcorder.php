...
//BALANCE
$sqlbal = mysqli_fetch_array(mysqli_query($connection, "SELECT * FROM balance where currency='BTC' AND available >= 0.00000026"));
$id= $sqlbal['id'];
...
<?php
$sqlbal1 = "SELECT * FROM balance where currency='BTC' AND available >= 0.00000026";
...
<?php
$sqlupd = "SELECT * FROM balance where currency='BTC' AND available >= 0.00000026 ";
...
$sqlsell = mysqli_fetch_array(mysqli_query($connection, "SELECT * FROM trade where symbol='DOGEBTC' order by price desc limit 1"));
$idsell= $sqlsell['id'];
...
<?php echo $quantity1update; echo "<br> quantity 2"; echo $quantity2update; echo "<br>"; ?>
<?php
...
//order end
    ...
    echo "0 sell order place doge balance low";
}
?>
//update trade table
<?php
